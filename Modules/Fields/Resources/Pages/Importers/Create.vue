...
const submitHandler = () => form.post(route('importers.store'));
</script>

<template>
  <AuthenticatedLayout title="Crear importador">
    <CollectionPageHeader
      title="Crear importador"
      description="Registra un nuevo importador. El slug se genera automáticamente."
    ...
    >
      ...
      <div class="mt-6 flex items-center justify-end gap-3 border-t border-[#e7eee8] pt-4">
        ...
        >
          {{ form.processing ? 'Guardando...' : 'Guardar importador' }}
        </button>
      </div>
    </form>
  </AuthenticatedLayout>
